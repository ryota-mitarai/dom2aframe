$(document).ready(function () {
  let toggleVisuals = function (imgElement, isRadio = false) {
    ...
    if (!isRadio) {
      if (currentlyChecked) imgElement.src = 'files/img/unchecked.png';
      else imgElement.src = 'files/img/checked.png';
    } else {
      if (currentlyChecked)
        // clicking already checked radio button does nothing
        return;
      ...
      $(imgElement)
        ...
        .children('img')
        .each((index, child) => {
          if (child != imgElement) child.src = 'files/img/unchecked.png';
          else child.src = 'files/img/checked_radio.png';
  ...
  $('#consoleInput').click(function (e) {
    ...
    if (inputEl !== document.activeElement) inputEl.focus();
  });
