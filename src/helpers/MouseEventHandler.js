...
class MouseEventHandler {
  ...
  _resync() {
    ...
    if (hasMouseEventRegistered || hasMouseProperty) {
      if (!aelement.d2alisteningForMouseEvents) {
        // TODO: maybe use something nicer than an extra property on the element to keep track of this state?
    ...
    } else if (aelement.d2alisteningForMouseEvents) {
      // neither event handlers nor event properties registered : can safely remove our listeners
