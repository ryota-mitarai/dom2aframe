...
class VideoElement {
  ...
  ToggleMode() {
    ...
    if (this.mode == 0) flatvid.setAttribute('visible', true);
    else flatvid.setAttribute('visible', false);

    if (this.mode == 1) this.sphericalvid.setAttribute('visible', true);
    else this.sphericalvid.setAttribute('visible', false);
  ...
  SetVisiblity(bool) {
    ...
    if (!this.IsVisible() && this.hassrc) document.getElementById(this.flatvid.getAttribute('src').substr(1)).pause();
  }
